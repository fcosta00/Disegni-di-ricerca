...
prova$corso <- rep( c('psicologia','ingegneria','biologia','statistica'), c(13,13,13,19) )
#prova$corso[1:13] <- 'psicologia'....

round( tapply(prova$Spritz, prova$corso, mean), 2)
round( with(prova, tapply(Spritz, corso, mean) ), 2 )
